  ...
  access_policies = [
    {
      ...
      access_policy_group_object_id = var.keyvault.access_policies[0].access_policy_group_object_id == null ? module.cluster_groups.group_ids[var.cluster_user_groups.admins.name] : var.keyvault.access_policies[0].access_policy_group_object_id
